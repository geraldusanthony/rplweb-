                   ...
                   <form class="well form-horizontal">
                      <fieldset>
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <label class="col-md-4 control-label">Judul KP</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class=""></i></span><input id="" name="" placeholder="" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         ...
                         <div class="form-group">
                            <label class="col-md-4 control-label">Status Ujian</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class=""></i></span><input id="" name="" placeholder="" class="form-control" required="true" value="" type="text"></div>
                            </div>
                         </div>
                         <div class="form-group">
                            <label class="col-md-4 control-label">Jadwal Ujian</label>
                            <div class="col-md-8 inputGroupContainer">
                               <div class="input-group"><span class="input-group-addon"><i class=""></i></span><input id="" name="" placeholder="" class="form-control" required="true" value="" type="text"></div>
                            </div>
                            </div>
